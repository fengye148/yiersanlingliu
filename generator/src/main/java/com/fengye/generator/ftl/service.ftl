package com.fengye.${module}.service;
...
import com.fengye.common.util.SnowUtil;
import com.fengye.${module}.domain.${Domain};
import com.fengye.${module}.domain.${Domain}Example;
import com.fengye.${module}.mapper.${Domain}Mapper;
